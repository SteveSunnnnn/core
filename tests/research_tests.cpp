...
void test_tech_eras_and_natural_spread() {
    ...
    // Run tech spread for 55 weeks to accumulate full spread progress
    for (int w = 0; w < 55; ++w) {
        research.run_tech_spread_weekly(world);
    }


    // Country B should have accumulated tech spread for traditional_farming
