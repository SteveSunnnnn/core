...
public:
    ...
    void insert(TerrainPatchKey key, const ProvinceRasterPage& page, std::uint64_t frame);
    ...
    [[nodiscard]] bool resident(TerrainPatchKey key) const noexcept;
    ...
    [[nodiscard]] TerrainPatchKey key_for_world(WorldMeters world, std::uint16_t level) const noexcept;
...
private:
    ...
    [[nodiscard]] ProvinceId pick_exact(WorldMeters world, TerrainPatchKey key, std::uint64_t frame) noexcept;
